...
!
      p_bio(ino2)= .91*r_bio(8)+1.2*r_bio(9)+r_bio(10) + (1.-xonit)*r_bio(19) ! RAZ 11/11/2014: added xoinit 
      d_bio(ino2)= 0.0
!
      p_bio(ino3)= 0.0
      d_bio(ino3)= r_bio(3)+r_bio(7) + r_bio(19)+r_bio(22) 	! RAZ 11/11/2014: (19 and 22 were missing)
!
...
!
      p_bio(ioh)= .27*r_bio(2)+.27*r_bio(6) + 0.85*r_bio(18) 	! RAZ 11/11/2014: added 0.85*r_bio(18)
      d_bio(ioh)= r_bio(1)+r_bio(5) + r_bio(17)+r_bio(20)    	! RAZ 11/11/2014: (17 and 20 were missing)
!
      p_bio(iho2)= .07*r_bio(2)+.33*r_bio(4)+.1*r_bio(6)   &
              +.93*r_bio(7)+.91*r_bio(8)+.8*r_bio(9)+r_bio(10) &
              + 0.24*r_bio(18)					! RAZ 11/11/2014: added 0.24*r_bio(18)
...
!
      p_bio(ihcho)= .6*r_bio(2)+.2*r_bio(4)+.15*r_bio(6)   &
               ...
               +0.37*r_bio(18)					! RAZ 11/11/2014: added 0.37*r_bio(18)
      d_bio(ihcho)= 0.0
!
...
!
      p_bio(ionit)= .93*r_bio(7)+.09*r_bio(8)+.8*r_bio(9)+r_bio(12)   &
               +r_bio(15) + xonit*r_bio(19)+r_bio(22)		! RAZ 11/11/2014: added 19 and 22
      d_bio(ionit)= 0.0
!
