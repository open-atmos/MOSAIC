! module_mosaic_aeroptic_intr.f90
module module_mosaic_aeroptic_intr
...
subroutine aerosol_optical(                 &
      it, cair_mol_m3, dens_comp_a, mw_comp_a,  & ! all in
...
!
! rce 2013-07-30
! *** this is note fully implemented yet for the "new openmp compliant" MOSAIC ***
...
!
  ...
  use module_data_mosaic_boxmod, only: cnn, lun_aeroptic, time_hrs, time_utc
  use module_data_mosaic_aero, only: naer, naercomp, nbin_a, nbin_a_max, &
      ngas_aerchtot, ngas_volatile, nelectrolyte
  use module_mosaic_box_aerchem, only: aerosol_optical_properties
  use module_mosaic_miedriver, only: miedriver
...
! *** rce 2014-12-07 -- the map routine has changed
!     so following call needs to be changed too
...
end module module_mosaic_aeroptic_intr
