...
!
      ...
      use module_data_mosaic_asecthp, only: &
          ...
          lptr_bc_aer, lptr_ca_aer, lptr_cl_aer, lptr_co3_aer, &
          lptr_msa_aer, lptr_na_aer, lptr_nh4_aer, lptr_no3_aer, &
          lptr_oc_aer, lptr_oin_aer, lptr_so4_aer, &
          mastercompptr_aer, mprognum_aer, &
          maxd_acomp, maxd_aphase, maxd_asize, maxd_atype, maxd_atype_md1, maxd_atype_md2, &
          ncomp_aer, ncomp_plustracer_aer, &
          nsize_aer, &
          hyswptr_aer, massptr_aer, numptr_aer, waterptr_aer, &
          name_aer, &
          dens_aer, &
