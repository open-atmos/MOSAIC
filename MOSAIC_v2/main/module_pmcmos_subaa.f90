...
!
	use module_data_mosaic_main, only:  &
	    avogad, naer_tot, ngas_max
	use module_data_mosaic_boxmod, only:  &
	    cair_mlc, cair_mlc_old, cair_molm3, cnn, dt_sec, &
	    istate_pblh, pblh, pblh_old, ppb, te, time_hrs, time_sec, &
	    knum_a, kwater_a
...
!
	use module_data_mosaic_main, only:  &
	    avogad, press0_pa
	use module_data_mosaic_boxmod, only:  &
	    cair_mlc, cair_mlc_old, cair_molm3, cair_molm3_old, &
	    istate_pblh, pblh, pblh_old, pr_atm, pr_atm_old,  &
