  module module_mosaic_init_aerosol
  ...
  !
  !   does initialization of variables in module_data_mosaic_asecthp
  !
...
!qak
  ...
  !BSINGH - load_mosaic_parameters is now called through mosaic_init_aer_params
  ...
  ! it uses the module_data_mosaic_asecthp arrays,
  ...
  end module module_mosaic_init_aerosol
